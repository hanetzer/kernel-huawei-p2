...
config_pair  hw_U9510E_configs [] = {
    ...
    {"gas_gauge/version", (unsigned int)0x32500a3, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"U9510E", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_U9510E= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_U9510E,
	.data_array={.config_pair_ptr=hw_U9510E_configs},
	.list={NULL,NULL},
};
