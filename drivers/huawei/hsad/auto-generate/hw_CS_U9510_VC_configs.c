...
config_pair  hw_CS_U9510_VC_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"CS_U9510_VC", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_CS_U9510_VC= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_CS_U9510_VC,
	.data_array={.config_pair_ptr=hw_CS_U9510_VC_configs},
	.list={NULL,NULL},
};
