...
bool bq27510_get_gasgauge_param_temperature(unsigned int* param_5,unsigned int* param_15)
{
    bool ret1 = 0, ret2 = 0;
    ...
    case BAT_ID_10K_STATUS:
        ...
        ret2 = get_hw_config_int("gas_gauge/temperature_15_10k", param_15, NULL);
        break;
    case BAT_ID_22K_STATUS:
        ret1 = get_hw_config_int("gas_gauge/temperature_5_22k", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15_22k", param_15, NULL);
        break;
    case BAT_ID_39K_STATUS:
        ret1 = get_hw_config_int("gas_gauge/temperature_5_39", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15_39", param_15, NULL);
        break;
    case BAT_ID_68K_STATUS:
        ret1 = get_hw_config_int("gas_gauge/temperature_5_68k", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15_68k", param_15, NULL);
        break;
    case BAT_ID_110K_STATUS:
        ret1 = get_hw_config_int("gas_gauge/temperature_5_110k", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15_110k", param_15, NULL);
        break;
    case BAT_ID_200K_STATUS:
        ret1 = get_hw_config_int("gas_gauge/temperature_5_200k", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15_200k", param_15, NULL);
        break;
    case BAT_ID_470K_STATUS:
        ret1 = get_hw_config_int("gas_gauge/temperature_5_470k", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15_470k", param_15, NULL);
        break;
    case BAT_ID_2M_STATUS:
        ret1 = get_hw_config_int("gas_gauge/temperature_5_2m", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15_2m", param_15, NULL);
        break;
    default:
        ret1 = get_hw_config_int("gas_gauge/temperature_5", param_5, NULL);
        ret2 = get_hw_config_int("gas_gauge/temperature_15", param_15, NULL);
        break;
    }
    ...
    if(!ret2)
        dev_info(di->dev,"%s: can't get %d temperature_15.\n",__FUNCTION__,battery_id_status);
