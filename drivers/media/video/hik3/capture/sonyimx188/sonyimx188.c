...
//#define SONYIMX188_AP_WRITEAE_MODE
...
#define SONYIMX188_AUTO_FPS_MAX_GAIN	0x60
#define SONYIMX188_AUTO_FPS_MIN_GAIN	0x24
...
static u32 sonyimx188_get_override_param(camera_override_type_t type)
{
	...
	case OVERRIDE_AUTO_FPS_GAIN_HIGH:
		ret_val = SONYIMX188_AUTO_FPS_MAX_GAIN;
		break;

	case OVERRIDE_AUTO_FPS_GAIN_LOW:
		ret_val = SONYIMX188_AUTO_FPS_MIN_GAIN;
		break;
...
static void sonyimx188_set_default(void)
{
	...
	sonyimx188_sensor.get_vts_reg_addr = sonyimx188_get_vts_reg_addr;
