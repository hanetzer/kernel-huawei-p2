...
#define S5K4E1GA_MAX_ISO 		800

#define S5K4E1GA_MIN_ISO                      100

#define S5K4E1GA_AUTO_FPS_MAX_GAIN 0x60

#define S5K4E1GA_AUTO_FPS_MIN_GAIN 0x24

#define S5K4E1GA_MAX_FRAMERATE         30

#define S5K4E1GA_MIN_FRAMERATE          15

#define S5K4E1GA_MIN_CAP_FRAMERATE  15
...
/* AEC */
	...
	{0x66401, 0x01}, //window weight
	{0x66402, 0x44}, //StatWin_Left
	{0x66403, 0x00},
	{0x66404, 0xf4}, //StatWin_Top
	{0x66405, 0x01},
	{0x66406, 0x44}, //StatWin_Right
	{0x66407, 0x00},
	{0x66408, 0xf4}, //StatWin_Bottom
	{0x66409, 0x02}, //definiton ofthe center 3x3 window
	{0x6640a, 0x1c}, //nWin_Left
	{0x6640d, 0x01},
	{0x6640e, 0x97}, //nWin_Top
	{0x66411, 0x03},
	{0x66412, 0x60}, //nWin_Width
	{0x66415, 0x02},
	{0x66416, 0x8a}, //nWin_Height
...
/* De-noise */
	...
	{0x6551c, 0x14}, //Richard for new curve 0320
	{0x6551d, 0x1a}, //Richard for new curve 0320
	{0x6551e, 0x1f}, //Richard for new curve 0320
	{0x6551f, 0x1f}, //Richard for new curve 0314
	{0x65520, 0x1f}, //Richard for new curve 0314
...
/* AWB */
	...
	{0x1ccd0, 0xf5},//R gain for A

	{0x1c5b8, 0x00},//B gain for C outdoor Richard@0517
	{0x1c5b9, 0x00},//R gain for C outdoor Richard@0517
	{0x1ccd1, 0x19},//B gain for C indoor Richard@0517
	{0x1ccd2, 0x09},//R gain for C indoor Richard@0517
	...
	{0x1c5b4, 0x00}, //C indoor/outdoor switch
	{0x1c5b5, 0x00}, //C indoor/outdoor switch
	{0x1c5b6, 0x00}, //C indoor/outdoor switch
	{0x1c5b7, 0x00}, //C indoor/outdoor switch
	...
	{0x66206, 0x13}, //center(cwf) window threshold D0
	{0x66207, 0x18}, //A threshold, range DX  0x15
	{0x66208, 0x18}, //day threshold, range DY 0xd
	{0x66209, 0x76}, //CWF X
	{0x6620a, 0x59}, //CWF Y
	{0x6620b, 0xed}, //K_A_X2Y, a slop
	{0x6620c, 0xb0}, //K_D65_Y2X, d slop
	{0x6620d, 0x49}, //D65 Limit//
	{0x6620e, 0x30}, //A Limit
	{0x6620f, 0x70}, //D65 split
	...
	{0x1c254, 0x01},//D  b_gain/r_gain*256 5050K
	{0x1c255, 0x20},
	{0x1c256, 0x01},//D-cwf 4700
	{0x1c257, 0x40},
	{0x1c258, 0x01},//cwf-a 3400k
	{0x1c259, 0xe0},
	{0x1c25a, 0x02},//a 2800k
	{0x1c25b, 0x10},
...
static u32 s5k4e1ga_get_override_param(camera_override_type_t type)
{
	...
	case OVERRIDE_AUTO_FPS_GAIN_HIGH:
		ret_val = S5K4E1GA_AUTO_FPS_MAX_GAIN;
		break;

	case OVERRIDE_AUTO_FPS_GAIN_LOW:
		ret_val = S5K4E1GA_AUTO_FPS_MIN_GAIN;
		break;
...
static void s5k4e1ga_foxconn_set_default(void)
{
	...
	s5k4e1ga_foxconn_sensor.ap_writeAE_delay = 1500; /* 5 expo and gain registers, 1500us is enough */
#else
