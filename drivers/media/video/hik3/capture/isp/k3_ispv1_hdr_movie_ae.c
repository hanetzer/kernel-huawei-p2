...
void ispv1_hdr_set_ae_status(u8 status)
{
 ...
 /*
  *************************************************************************
  * FunctionName: ispv1_hdr_isp_ae_switch;
  * Description : the function that turn on or off the ae of ISP, if value is 0 , the ae arithmatic of ISP is used, otherwise ae of AP is used.
  * Input			: 0 is the ISP's ae arithmatic . 1 is he AP of ae.
  * Output		: NA;
  * ReturnValue 	: NA;
  * Other       		:
  **************************************************************************
...
void ispv1_hdr_isp_ae_switch(u8 on)
{
 ...
 /*
  *************************************************************************
  * FunctionName: 	: ispv1_hdr_isp_ae_ctrl;
...
void ispv1_hdr_set_analog_gain_exposure(hdr_ae_algo_result * ae_result)
{
	...
	if(_IS_DEBUG_AE)
	{
		print_info("global_gain = %d ,expo_long = %d,gain_short = %d,expo_short = %d", global_gain,expo_long,gain_short,expo_short);
	}
...
void ispv1_get_hdr_movie_ae_init_param(hdr_ae_constant_param * hdr_ae_param)
{
	camera_sensor *sensor = this_ispdata->sensor;
	u32 C_shuter = 0;
	u16 C_gain = 0;
...
* Other       		: NA;
***************************************************************************/
void ispv1_get_hdr_movie_ae_running_param(hdr_ae_volatile_param * output_param)
{
