...
#define SONYIMX135_MAX_ISO_LOWLIGHT	3200

#define SONYIMX135_AUTO_FPS_MAX_GAIN	0x88
#define SONYIMX135_AUTO_FPS_MIN_GAIN	0x24
...
const struct isp_reg_t isp_init_regs_sonyimx135_lowlight[] = {
...
/* De-noise & sharpness have been setting in k3_ispv1_tune_ops */
	{0x65604, 0x00}, //Richard for new curve 0314
	{0x65605, 0x00}, //Richard for new curve 0314
	{0x65606, 0x00}, //Richard for new curve 0314
	{0x65607, 0x00}, //Richard for new curve 0314
...
/* auto uv saturation */
	...
	{0x1c4ec, 0x78}, //UV min saturation
...
/* AWB */
	...
	{0x66206, 0x11}, //center(cwf) window threshold D0
	{0x66207, 0x20}, //A threshold, range DX  0x15
...
static int sonyimx135_init_isp_reg(void)
{
	...
	/* < zhoutian 00195335 2013-03-02 added for SuperZoom-LowLight begin */
	else if (true == sonyimx135_sensor.hw_lowlight_on)
	{
		size = ARRAY_SIZE(isp_init_regs_sonyimx135_lowlight);
		sonyimx135_write_isp_seq(isp_init_regs_sonyimx135_lowlight, size);
	}
	/* zhoutian 00195335 2013-03-02 added for SuperZoom-LowLight end > */
	else
	{
...
static u32 imx135_get_override_param(camera_override_type_t type)
{
	...
	case OVERRIDE_AUTO_FPS_GAIN_HIGH:
		ret_val = SONYIMX135_AUTO_FPS_MAX_GAIN;
		break;

	case OVERRIDE_AUTO_FPS_GAIN_LOW:
		ret_val = SONYIMX135_AUTO_FPS_MIN_GAIN;
		break;
	...
	case OVERRIDE_ISO_HIGH_LOWLIGHT:
		ret_val = SONYIMX135_MAX_ISO_LOWLIGHT;
		break;
...
static void sonyimx135_set_default(void)
{
	...
	sonyimx135_sensor.hw_lowlight_on			= false;
	/* zhoutian 00195335 2013-03-02 added for SuperZoom-LowLight end > */
}
