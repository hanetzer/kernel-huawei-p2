...
#define OV8830_MAX_ISO_LOWLIGHT	2400

#define OV8830_AUTO_FPS_MAX_GAIN	0x40
#define OV8830_AUTO_FPS_MIN_GAIN	0x16
...
const struct isp_reg_t isp_init_regs_lowlight_ov8830_backup[] = {
	//auto uv saturation
...
static u32 ov8830_get_override_param(camera_override_type_t type)
{
	...
	case OVERRIDE_ISO_HIGH_LOWLIGHT:
		ret_val = OV8830_MAX_ISO_LOWLIGHT;
		break;
