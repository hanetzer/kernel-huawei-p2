...
#ifdef CONFIG__USE_WIFI_DISPLAY_NO
#define HISI_MEM_CODEC_SIZE	(27 * SZ_1M)
#else
#define HISI_MEM_CODEC_SIZE	(27 * SZ_1M + 15 * SZ_1M)
#endif
...
#else
#define HISI_PMEM_GRALLOC_SIZE	(110 * SZ_1M)
#endif
...
#define HIGPU_BUF_SIZE (CONFIG_PMEM_HIGPU_BUF_SIZE * SZ_1M + HISI_MEM_COPYBIT_SIZE)
#else
#if defined(CONFIG_OVERLAY_COMPOSE)
#  if defined(CONFIG_LCD_1080P)
#  define HIGPU_BUF_SIZE	(36 * SZ_1M + HISI_MEM_COPYBIT_SIZE)
#  else
#  define HIGPU_BUF_SIZE	(64 * SZ_1M + HISI_MEM_COPYBIT_SIZE)
#  endif
#else
#  if defined(CONFIG_LCD_1080P)
...
#define HISI_FRAME_BUFFER_SIZE  PAGE_ALIGN(1280 * ALIGN_UP(720, 16) * 4 * NUM_FRAME_BUFFERS)
#else
#define HISI_FRAME_BUFFER_SIZE  PAGE_ALIGN(1920 * ALIGN_UP(1080, 16) * 4 * NUM_FRAME_BUFFERS)
#endif
