...
bool k3v2_timer_mode_enable;
static __devexit k3v2_wakeup_timer_suspend(struct platform_device *pdev)
{
...
static __devexit k3v2_wakeup_timer_resume(struct platform_device *pdev)
{
